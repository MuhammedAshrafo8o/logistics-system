...
class UpdateWarehouseChargeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'type' => ['sometimes', Rule::in(WarehouseChargeType::values())],
            'description' => ['sometimes', 'nullable', 'string', 'max:255'],
            'quantity' => ['sometimes', 'nullable', 'numeric', 'min:0.01'],
            'unit_price' => ['sometimes', 'numeric', 'min:0'],
            'status' => ['sometimes', Rule::in(WarehouseChargeStatus::values())],
            'charge_date' => ['sometimes', 'nullable', 'date'],
